...
SDSS, QCGI, PVCP, and AVAT experiments with proper pre-registration,
...
class ExperimentConfig:
    ...
    experiment_type: str  # SDSS, QCGI, PVCP, or AVAT
    models: List[str]
    ...
    def __post_init__(self):
        if self.metrics is None:
            ...
            elif self.experiment_type == "AVAT":
                self.metrics = ["misalignment", "threshold", "compositionality"]
